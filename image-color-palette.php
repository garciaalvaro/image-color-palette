...
if ( ! defined( 'IMAGECOLORPALETTE_PLUGIN_VERSION' ) ) {
	define( 'IMAGECOLORPALETTE_PLUGIN_VERSION', '1.1.0' );
}
...
function enqueue() {
	...
	$data = array(
		'local'  => array(
			'clipboard_copy'              => __( 'Click to copy to the clipboard', 'image-color-palette' ),
			'clipboard_copied'            => __( 'Copied to the clipboard', 'image-color-palette' ),
